...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', type=int, default=0, help='random seed, set to different values for repeats')
    ...
    parser.add_argument('--confidence_rate', type=float, default=0.7, help='threshold of the classification confidence for the selection of pseudo labeled target samples, 0.7 for all datasets')
    parser.add_argument('--WA_N_hid', type=int, default=5, help='the number of neurons in the hidden layer of weight allocator, 5 for PAMAP2, 5 for OPPORTUNITY, and 7 for RealWorld')
